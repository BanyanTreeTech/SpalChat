...
const NSUInteger kQMApplicationID = 26208;
NSString *const kQMAuthorizationKey = @"y2uv49SV3BB3Hpz";
NSString *const kQMAuthorizationSecret = @"YttvTAXORrSUpf8";
NSString *const kQMAcconuntKey = @"bMuC9XrTuVXznEL8JVBk";
